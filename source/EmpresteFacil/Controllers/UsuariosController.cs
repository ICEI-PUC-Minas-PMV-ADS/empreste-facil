...
>>>>>>> origin/Tafarel_Dev
        ...
        public async Task<IActionResult> Create([Bind("UsuarioId,Email,Celular,TelefoneFixo,Perfil, Senha, Nome")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
                ...
                if (usuario.Perfil == Perfil.Pessoa_Fisica)
                {
                    return RedirectToAction("Create", "PessoaFisicas", usuario);
                }
                else
                {
                    return RedirectToAction("Create", "PessoaJuridicas", usuario);
                }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UsuarioId,Email,Celular,TelefoneFixo,Senha,Perfil")] Usuario usuario)
        {
