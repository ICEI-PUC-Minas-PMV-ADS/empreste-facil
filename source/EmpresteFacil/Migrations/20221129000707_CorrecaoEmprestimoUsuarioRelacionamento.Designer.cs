...
namespace EmpresteFacil.Migrations
{
    ...
    [Migration("20221129000707_CorrecaoEmprestimoUsuarioRelacionamento")]
    partial class CorrecaoEmprestimoUsuarioRelacionamento
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmpresteFacil.Models.PedidoDeEmprestimo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmpresteFacil.Models.Usuario", b =>
                {
            ...
            modelBuilder.Entity("EmpresteFacil.Models.Emprestimo", b =>
                {
                    b.HasOne("EmpresteFacil.Models.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("EmpresteFacil.Models.Parcelas", b =>
                {
                    b.HasOne("EmpresteFacil.Models.Emprestimo", "Emprestimo")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EmpresteFacil.Models.Usuario", null)
                        .WithMany()
